...
#	B = f' en-us; Huawei Build/{str(rc(aZ))}{str(rc(aZ))}{str(rc(aZ))}63{str(rc(aZ))}; ) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 UCBrowser/'
