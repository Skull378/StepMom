...
#------------------[ LOGO-LAKNAT ]-----------------#
def banner():
	cetak(panel(f"""""",width=90,padding=(0,8),title=f"SIGLET",style=f"bold white"))
#--------------------[ BAGIAN-MASUK ]--------------#
def login123():
	os.system('clear')
	banner()
...
def menu(my_name,my_id):
	...
	cetak(panel(f"[bold white]SURABAYA , JAKARTA , JAWA TENGAH , SOLO , TEGAL , MALANG , MEDAN , MANADO , LAMPUNG , BALI",width=90,title=f"[bold green]Thanks To",style=f"bold white"))
