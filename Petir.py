...
#	B = f' en-us; SAMSUNG Build/{str(rc(aZ))}{str(rc(aZ))}{str(rc(aZ))}63{str(rc(aZ))}; ) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/'
...
#	else:redmi.append(mi)
	...
	C = f'{str(rr(4,30))} Build/{B}) AppleWebKit/537.36 (KHTML, like Gecko)'
